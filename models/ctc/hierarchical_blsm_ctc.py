...
class Hierarchical_BLSTM_CTC(ctcBase):
    """Hierarchical Multi-task Bidirectional LSTM-CTC model.
    Args:
        ...
        num_layer2: int, the number of layers of the second task. Set between
            1 to num_layer
                ...
                if i_layer == self.num_layer2:
                    ...
                    with tf.name_scope('output2'):
                        ...
                        logits2_3d = tf.reshape(
                            logits2_2d,
                            shape=[batch_size, -1, self.num_classes2])
