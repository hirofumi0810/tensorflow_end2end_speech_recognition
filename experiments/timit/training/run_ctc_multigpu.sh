...
# CUDA_VISIBLE_DEVICES=$gpu_index nohup $PYTHON train_ctc_multigpu.py $config_path $gpu_index > log/$filename".log" &

# Standard output version
CUDA_VISIBLE_DEVICES=$gpu_index $PYTHON train_ctc_multigpu.py $config_path $gpu_index
