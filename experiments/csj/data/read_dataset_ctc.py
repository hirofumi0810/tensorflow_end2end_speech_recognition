...
class DataSet(object):
    ...
    def __init__(self, data_type, train_data_size, label_type,
        ...
        for input_name, frame_num in iterator:
            ...
            if os.path.isfile(os.path.join(self.dataset_path, 'input',
                                           speaker_name, input_name + '.npy')):
                input_paths.append(os.path.join(self.dataset_path, 'input',
                                                speaker_name, input_name + '.npy'))
            else:
                input_paths.append(os.path.join(self.dataset_plus_path, 'input',
                                                speaker_name, input_name + '.npy'))
            if os.path.isfile(os.path.join(self.dataset_path, 'label',
                                           speaker_name, input_name + '.npy')):
                label_paths.append(os.path.join(self.dataset_path, 'label',
                                                speaker_name, input_name + '.npy'))
            else:
                label_paths.append(os.path.join(self.dataset_plus_path, 'label',
                                                speaker_name, input_name + '.npy'))
